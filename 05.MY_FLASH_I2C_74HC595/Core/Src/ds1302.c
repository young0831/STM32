...
#include <stdio.h>
#include <stdlib.h>
DisplayMode_t displayMode = MODE_CLOCK;
AlarmState_t alarmState = ALARM_SET;
...
//	   {
//		   if(get_button( GPIOC, GPIO_PIN_0, BTN0 ) == BUTTON_PRESS)// 시계->alarm시각설정
//			{
//			   alarmState = ALARM_SET;
//			}
//			if(get_button( GPIOC, GPIO_PIN_1, BTN1 ) == BUTTON_PRESS) //시계 display<->alarm 시계
//			{
